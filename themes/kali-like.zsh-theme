...
configure_prompt() {
    ...
    case "$PROMPT_ALTERNATIVE" in
        twoline)
            PROMPT=$'%B$CYANPROMPT┌───\(%B$FGPROMPT%n$FG[015]@$FGPROMPT%m%B$CYANPROMPT)-[%B%F{reset}%(6~.%-1~/…/%4~.%5~)%B$CYANPROMPT]$(git_prompt_info)\n%B$CYANPROMPT└─%(#.%F{red}#.$FGPROMPT$)%b%F{reset} '
            RPROMPT=
            ;;
        oneline)
...
if [ "$USE_SYNTAX_HIGHLIGHTING" = yes ]; then
    ...
    CL_PURPLE="135"
        ...
        ZSH_HIGHLIGHT_STYLES[suffix-alias]=fg=$CL_PINK,underline
        ZSH_HIGHLIGHT_STYLES[global-alias]=fg=$CL_PINK,bold
        ZSH_HIGHLIGHT_STYLES[precommand]=fg=$CL_PINK,underline
        ZSH_HIGHLIGHT_STYLES[commandseparator]=fg=blue,bold
        ZSH_HIGHLIGHT_STYLES[autodirectory]=fg=$CL_PINK,underline
        ...
        ZSH_HIGHLIGHT_STYLES[single-hyphen-option]=fg=$CL_PINK
        ZSH_HIGHLIGHT_STYLES[double-hyphen-option]=fg=$CL_PINK
        ...
        ZSH_HIGHLIGHT_STYLES[arg0]=fg=135
        ZSH_HIGHLIGHT_STYLES[bracket-error]=fg=red,bold
        ZSH_HIGHLIGHT_STYLES[bracket-level-1]=fg=blue,bold
        ZSH_HIGHLIGHT_STYLES[bracket-level-2]=fg=$CL_PINK,bold
        ZSH_HIGHLIGHT_STYLES[bracket-level-3]=fg=magenta,bold
        ZSH_HIGHLIGHT_STYLES[bracket-level-4]=fg=yellow,bold
        ZSH_HIGHLIGHT_STYLES[bracket-level-5]=fg=135,bold
